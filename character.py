...
class Character():
    def __init__(self, x, y, health, mob_animations, char_type, boss, size):
        ...
        self.rect = pygame.Rect(0, 0, constants.TILE_SIZE * self.size, constants.TILE_SIZE * self.size)
    ...
    def move(self, dx, dy, obstacle_tiles, exit_tile = None):
        ...
        if self.char_type == 0:
            ...
            if exit_tile[1].colliderect(self.rect):
                exit_tile = math.sqrt(((self.rect.centerx - exit_tile[1].centerx) ** 2) + ((self.rect.centery - exit_tile[1].centery) ** 2))
                if exit_tile < 20:
                    level_complete = True
    ...
    def ai(self, player, obstacle_tiles, screen_scroll, fireball_image):
        ...
        #validar distancia entre jugador y enemigo
